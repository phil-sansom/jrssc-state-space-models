...
C0 = diag(c(5,wbeta,rep(5,4),rep(1,p),rep(1,p),10,rep(0.5,p))^2)
...
# ## Open eps device
# postscript(file = "sim-tvar-good-delta.eps", width = width, height = height,
...
## Open eps device
postscript(file = "sim-tvar-good-mu.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
...
## Open eps device
postscript(file = "sim-tvar-good-beta.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
...
## Open eps device
postscript(file = "sim-tvar-good-psi1.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
...
## Open eps device
postscript(file = "sim-tvar-good-psi2.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
...
## Coefficients
## Open eps device
postscript(file = "sim-tvar-good-phi.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
...
## Open eps device
postscript(file = "sim-tvar-good-delta-mean.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
...
## Open eps device
postscript(file = "sim-tvar-good-amplitude.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
...
## Open eps device
postscript(file = "sim-tvar-good-phase.eps", width = width, height = height,
           pointsize = 8, paper = "special", horizontal = FALSE)
