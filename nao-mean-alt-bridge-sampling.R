...
lb = c(-32,-32,-64,-2.5,-1.0,-3.0,-64,-21,-12,  0,  0,-12)
ub = c(  0,- 2,-18,+3.5,+5.0,+3.0,- 8,+ 5,+12,365,365,+12)
...
## Save results
save(marginal.likelihood, file = "nao-mean-alt-marginal-likelihood.RData")
